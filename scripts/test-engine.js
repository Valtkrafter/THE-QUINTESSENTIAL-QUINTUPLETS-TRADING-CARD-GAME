 ...
 */
import { CARDS_CATALOG, CARDS_BY_RARITY, CARDS_BY_CHARACTER, getCardDef, } from '../src/config/cardsData.js';
import { calculateRawCardValue, calculateGradedCardValue, calculateGradingFee, calculateDustYield, rollGrading, rollPackDrops, analyzeBinderPage, calculateAccruedIdleEarnings, PACKS_CONFIG, CONSUMABLE_TOOLS, GRADE_TIER_CONFIG, NAKANO_SISTERS, } from '../src/config/economy.js';
...
async function runTests() {
    ...
    const allRarities = ['C', 'UC', 'R', 'SR', 'UR', 'SEC', 'MR'];
    ...
    const rarities = ['C', 'UC', 'R', 'SR', 'UR', 'SEC', 'MR'];
    ...
    const supportChars = ['fuutarou', 'raiha', 'maruo', 'isanari', 'takeda'];
    ...
    for (const tier of Object.keys(baselineTiers)) {
